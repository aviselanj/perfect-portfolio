  ...
  return (
    <main className="flex flex-col items-center w-full min-h-screen gap-24 py-12 px-4 sm:px-8 md:px-16 bg-gradient-to-r from-new-orleans-purple to-new-orleans-gold text-white">
      ...
      <section id="hero" className="w-full max-w-4xl text-center flex flex-col items-center gap-4 pt-8">
        <h1 className="text-4xl sm:text-6xl font-serif font-bold animate-float text-mardiGold drop-shadow-lg">Avielle Lewis</h1>
        <h2 className="text-xl sm:text-2xl font-serif animate-float text-mardiPurple mb-2">The Portfolio of a Full Stack Developer</h2>
        <p className="text-lg max-w-xl mx-auto animate-float">Building beautiful, performant web experiences with a New Orleans vibe.</p>
      </section>
      ...
      <section id="projects" className="w-full max-w-5xl">
        <h3 className="text-2xl font-bold text-mardiGold mb-6 font-serif animate-float">Projects</h3>
        <div className="grid gap-8 md:grid-cols-2">
          ...
          <div className="bg-mardiBlue/90 rounded-lg shadow-md p-6 border-l-4 border-mardiGold hover:scale-[1.03] transition-transform duration-300">
            <h4 className="text-xl font-bold text-mardiGold font-serif mb-2">Big Easy Events</h4>
      ...
      {/* Contact Section */}
      <section id="contact" className="w-full max-w-2xl bg-mardiPurple/80 rounded-xl shadow-lg p-8 text-mardiGold font-serif animate-float">
